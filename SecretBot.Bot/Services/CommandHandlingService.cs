...
public class CommandHandlingService
{
    ...
    private async Task MessageReceivedAsync(SocketMessage rawMessage)
    {
        ...
        Console.WriteLine($"New message from {message.Author}: {message.Content}"); //todo delete
        ...
        if (!message.HasStringPrefix(_configuration["BotSettings:DISCORD_BOT_COMMAND_PREFIX"] ?? "!", ref argPos))
